...
(
    id_aerolinea int identity not null,
...
(
    id_estadopago int identity not null,
...
CREATE TABLE Paypal
(
    id_paypal int identity not null,
...
(
    id_secciones int identity not null,
...
(
    id_pasajero int identity not null,
...
(
    id_aeropuerto int identity not null,
...
(
    id_asiento int identity not null,
    num_fila int,
    num_columna int,
    id_secciones int,
...
CREATE TABLE Avion
(
    id_avion int identity not null,
    numfila_avion int,
...
CREATE TABLE Vuelos
(
    id_vuelo int identity not null,
    fecha_vuelo date,
...
(
    id_asiento int,
    id_vuelo int,
	CONSTRAINT PK_idasiento FOREIGN KEY (id_asiento)REFERENCES Asientos(id_asiento),
	CONSTRAINT FK_idvuelo FOREIGN KEY (id_vuelo)REFERENCES Vuelos(id_vuelo)
)

CREATE TABLE Boleto
(
    id_boleto int identity not null,
    id_vuelo int,
    id_asiento int,
    id_pasajero int,
...
(
    id_tarjeta int identity not null,
...
(
    id_reservacion int identity not null,
    id_vuelo int,
